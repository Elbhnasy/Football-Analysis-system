...
class SpeedAndDistanceEstimator():
    def __init__(self):
        """
        Initializes the SpeedAndDistanceEstimator with the given frame window and frame rate.
    ...
    def add_speed_and_distance_to_tracks(self,tracks):
        """
        Adds speed and distance information to the tracks.
    ...
    def draw_speed_and_distance(self,frames,tracks):
        """
        Draws speed and distance information on the frames.
        ...
        Returns:
            list: List of frames with speed and distance information drawn on them.
        """
        output_frames = []
